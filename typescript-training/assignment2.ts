...
console.log("Temperature of a city:" +temparature);

// 2. Whether a customer has placed an order: true or false
let orderPlaced:boolean=true;
console.log("customer has placed an order:" +orderPlaced);

// 3. Person's phone number: "123-456-7890"
let number1:number=1234567890;
console.log("Person's phone number:" +number1);
...
console.log("Person's email address:" +address);
...
console.log("movie rating is:" +movieRating);
